...
export const getTrend = ({ days = 30, hours, bucketHours } = {}) => request.get('/dashboard/trend', { params: { days, ...(hours ? { hours, bucket_hours: bucketHours || 1 } : {}) } })
...
export const getModelUsage = (days = 30, limit = 8, { hours, bucketHours } = {}) => request.get('/dashboard/model-usage', { params: { days, limit, ...(hours ? { hours, bucket_hours: bucketHours || 1 } : {}) } })
